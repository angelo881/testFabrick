...
public class ApiController {
	...
	public ResponseEntity<Long> letturaSaldo(@RequestParam @ApiParam(example = "14537780") Long accountId) {
	...
	public ResponseEntity<ResponseBonifico> bonifico(@RequestParam @ApiParam(example = "14537780") Long accountId,
			@RequestParam("creditorName") @ApiParam String creditorName, @RequestParam("accountCode") @ApiParam String accountCode,
			@RequestParam("description") @ApiParam String description, @RequestParam("currency") @ApiParam String currency,
			@RequestParam("amount") @ApiParam String amount,
	...
	public ResponseEntity<Map<String, String>> letturaTransazioni(@RequestParam @ApiParam(example = "14537780") Long accountId,
